...
contract WeightedRandomSelectorHarness {
    ...
    function calculateDepositWeights(
        ...
        return WeightedRandomSelector.calculateDepositWeights(
            currentAllocations,
            targetAllocations
        );
    }
    ...
    function calculateWithdrawalWeights(
        ...
        return WeightedRandomSelector.calculateWithdrawalWeights(
            currentAllocations,
            targetAllocations
        );
    }
    ...
    function selectWeightedRandom(
        ...
        return WeightedRandomSelector.selectWeightedRandom(
            items,
            weights,
            count,
            randomSeed
    ...
    function testSelectSingleWeightedRandom(
        ...
        (address[] memory selectedArray, uint256[] memory selectedIndices) = 
            WeightedRandomSelector.selectWeightedRandom(items, weights, 1, randomSeed);
