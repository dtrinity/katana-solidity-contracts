...
import { ETH_ORACLE_AGGREGATOR_ID, USD_ORACLE_AGGREGATOR_ID } from "../../typescript/deploy-ids";
...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  await transferOracleAggregatorRoles(hre, ETH_ORACLE_AGGREGATOR_ID, "S", deployerSigner, governanceMultisig, deployer);
