...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment): Promise<boolean> {
  ...
  const redstoneWrapperDeployment = await hre.deployments.deploy(ETH_REDSTONE_ORACLE_WRAPPER_ID, {
    from: deployer,
  ...
  const redstoneWrapperWithThresholdingDeployment = await hre.deployments.deploy(ETH_REDSTONE_WRAPPER_WITH_THRESHOLDING_ID, {
    from: deployer,
    args: [baseCurrency, baseCurrencyUnit],
  ...
  const redstoneCompositeWrapperDeployment = await hre.deployments.deploy(ETH_REDSTONE_COMPOSITE_WRAPPER_WITH_THRESHOLDING_ID, {
    from: deployer,
    args: [baseCurrency, baseCurrencyUnit],
...
func.tags = ["deth", "oracle-aggregator", "oracle-wrapper", "eth-redstone-oracle-wrapper"];
