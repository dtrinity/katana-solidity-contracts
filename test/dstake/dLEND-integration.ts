...
import { createDStakeFixture, DStakeFixtureConfig, SDETH_CONFIG, SDUSD_CONFIG } from "./fixture";

const STAKE_CONFIGS: DStakeFixtureConfig[] = [SDUSD_CONFIG, SDETH_CONFIG];

STAKE_CONFIGS.forEach((cfg) => {
  describe.skip(`dStake Ecosystem - ${cfg.DStakeTokenSymbol} - Basic Deposit and dLEND Interaction Verification`, function () {
