...
export const MORPHO_CHAINLINK_DATA_FEED_DECIMALS = 36;
export const MORPHO_CHAINLINK_DATA_BASE_CURRENCY_UNIT = 10n ** BigInt(MORPHO_CHAINLINK_DATA_FEED_DECIMALS);
